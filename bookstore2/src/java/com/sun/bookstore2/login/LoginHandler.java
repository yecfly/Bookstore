...
import com.sun.bookstore2.account.*;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (logout != null) {
                ...
                request.getRequestDispatcher("/books/bookstore.jsp")
                ...
                if (success) {
                    ...
                    request.getRequestDispatcher("/books/bookstore.jsp?login=1")
                            .forward(request, response);
                } else {
                    request.getRequestDispatcher("/books/bookstore.jsp?login=0")
                            .forward(request, response);
                }
            }
        } finally {
